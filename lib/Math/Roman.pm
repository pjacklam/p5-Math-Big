...
#############################################################################
# Math/Roman.pm -- package which defines a base class for calculating
# with Roman numbers as well as converting from/to decimal.
#
# Well, it seems I have been infected be the Perligata-Virus, too. ;o)
#
# Copyright (C) MCMXCIX-MM by Tels. All rights reserved.
#############################################################################
